...
import styles from '@/app/(categories)/event/[id]/components/Hero/Hero.module.scss'
...
function EventTeam () {
  return (
    ...
    <RoundedImg width={144} height={144}>
      <Image src='https://www.flashscore.com/res/image/data/tSfwGCdM-KKWyfaNo.png' alt='team' width={120} height={120}/>
    </RoundedImg>
